...
Per my [home solar project](./../../../pages/Solar-Project.md), I needed a method to collect data from both my batteries and inverters, in near-real-time, with no dependancy on the internet.
