...
It is absolutely horrible, if you want to use layer 3 switches. Also, "POE" and "10G", results in the same switch costing twice as much.
...
??? "Unifi Hardware - Click to expand"
    ...
    2. **Unifi: USW-Pro-24**:
        - Horrible excuse for a "Layer 3" switch.
